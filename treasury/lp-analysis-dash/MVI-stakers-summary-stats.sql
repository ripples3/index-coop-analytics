...
This query grabs specific summary stats from the overall MVI staker distribution.
Jack's query: https://duneanalytics.com/queries/95456

*/

-- the following is taken heavily from MVI-stakers-distirbution-behavior.sql
